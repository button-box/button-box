...
| `messagebox-nfc.service` | Read recipient cards and maintain NFC selection state (or, with `MSGBOX_NFC_TRANSPORT=switch`, read a 4-position rotary switch as a card substitute -- no PN532 reader required) |
