...
except ImportError:  # Support the installed script entrypoint.
...
ENABLED_PATH = Path("/etc/messagebox-onboarding/enabled")
CONFIGURED_PATH = Path("/etc/messagebox-onboarding/configured")
STATE_PATH = Path("/var/lib/messagebox-onboarding/state.json")
