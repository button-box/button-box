...
SOCKET_PATH = "/run/messagebox-whatsapp-pairing/worker.sock"
PAIRING_ROOT = "/var/lib/messagebox/whatsapp-pairing"
LIVE_STORE = "/var/lib/messagebox/wacli"
CANDIDATES_PATH = "/var/lib/messagebox/wacli/onboarding-candidates.json"
