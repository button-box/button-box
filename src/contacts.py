...
try:
    from runtime_paths import ASSET_DIR, CONTACTS_FILE, NFC_ENROLLMENT_FILE
except ModuleNotFoundError:
    from src.runtime_paths import ASSET_DIR, CONTACTS_FILE, NFC_ENROLLMENT_FILE
...
def _stage_enrollment(contact, *, create_contact, enrollment_factory=None) -> None:
    if enrollment_factory is None:
        try:
            from nfc_state import EnrollmentStore
        except ModuleNotFoundError:
            from src.nfc_state import EnrollmentStore
