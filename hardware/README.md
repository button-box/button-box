...
The Waveshare HAT matches the current NFC software adapter and avoids soldering
the NFC reader connection. The button and lamp still need their own wiring. The
[European EL001 enclosure](enclosure/eu-el001/README.md) includes a digital
assembly check for this HAT, but the S8 print and NFC range have not been
physically verified. The earlier prototype enclosure was designed around the
HiLetgo module.
