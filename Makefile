...
syntax:
	...
	for file in scripts/*.sh scripts/commands/* scripts/dev/authorize-controller-key.sh scripts/dev/onboard.sh scripts/dev/hardware-test.sh scripts/dev/reprovision.sh scripts/install/*.sh; do sh -n "$$file"; done
...
lint-shell:
	uvx --from shellcheck-py==0.11.0.1 shellcheck --exclude=SC1007,SC1091,SC2029 scripts/*.sh scripts/commands/* scripts/dev/authorize-controller-key.sh scripts/dev/onboard.sh scripts/dev/hardware-test.sh scripts/dev/reprovision.sh scripts/install/*.sh scripts/messageboxctl messagebox/syncloop.sh
