...
syntax:
	PYTHONPYCACHEPREFIX=/tmp/messagebox-pycache python3 -m compileall -q messagebox tests scripts/dev/validate_acceptance_run.py scripts/install/audio_config.py scripts/install/bounded_update.py scripts/install/tailscale_dashboard.py scripts/dev/release-manifest.py
...
lint-python:
	uvx --from ruff==0.16.3 ruff check --target-version=py313 --select=E4,E7,E9,F messagebox tests scripts/install/audio_config.py scripts/install/bounded_update.py scripts/install/tailscale_dashboard.py scripts/dev/release-manifest.py
